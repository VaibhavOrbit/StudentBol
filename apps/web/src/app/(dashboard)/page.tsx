    ...
    <section className="flex justify-center mt-10 px-6 py-16">
      <div className="w-full max-w-6xl">
        ...
        <div className="text-center">
          ...
          <h1 className="mt-2 md:text-6xl text-4xl  text-gray-900 ">
            Real Students. Real Insights. <br /> Real Earnings.
          </h1>
          <p className="mt-6 md:text-xl text-base max-w-2xl mx-auto text-gray-700">
        ...
        <div className="">
          ...
          {/* Card 1 */}
          <div className="max-w-md bg-white shadow-md rounded-2xl p-6 text-center border border-gray-200 hover:shadow-lg transition">
